...
const Navbar = () => {
  ...
  return (
    <nav className='fixed h-20 w-full z-20 px-4 lg:px-16 flex justify-between items-center gap-4 md:gap-0 bg-black/20 shadow-md backdrop-blur-sm'>
      ...
      <button className='md:hidden' type='button' onClick={() => setOpenMenu(true)}><Menu /></button>
